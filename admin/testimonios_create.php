    ...
    if (empty($nombre)) {
        ...
        if (!$error) {
            ...
            if (createRecord('testimonios', $data)) {
                $success = 'Testimonio creado exitosamente';
                // Limpiar formulario
                $_POST = [];
            } else {
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Crear Testimonio</h1>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="fas fa-plus me-2"></i>Información del Testimonio
                </h5>
            </div>
            <div class="card-body">
                <?php if ($error): ?>
                ...
                <form method="POST" enctype="multipart/form-data" id="testimonioForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="testimonio" name="testimonio" rows="4" required><?php echo htmlspecialchars($_POST['testimonio'] ?? ''); ?></textarea>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="calificacion" name="calificacion" required>
                                    ...
                                    <?php for ($i = 1; $i <= 5; $i++): ?>
                                        <option value="<?php echo $i; ?>" <?php echo ($_POST['calificacion'] ?? '') == $i ? 'selected' : ''; ?>>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Crear Testimonio
                        </button>
                    </div>
                </form>
            </div>

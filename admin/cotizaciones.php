...
if ($ver_entregadas) {
    ...
    $pageActions = '<a href="exportar_cotizaciones.php" class="btn btn-success" title="Exporta todas las cotizaciones del sistema, sin importar los filtros del listado"><i class="fas fa-file-excel me-2"></i>Exportar todas</a> <a href="cotizaciones_create.php" class="btn btn-primary"><i class="fas fa-plus me-2"></i>Nueva Cotización</a> <a href="cotizaciones.php?ver_entregadas=1" class="btn btn-info"><i class="fas fa-truck me-2"></i>Ver Órdenes Entregadas</a>';
}

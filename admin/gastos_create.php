...
if ($_POST) {
    ...
    if (empty($concepto)) {
        ...
        if (empty($error)) {
            ...
            if (createRecord('gastos', $gasto_data)) {
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Nuevo Gasto</h1>
            <p class="text-muted">Registra un nuevo gasto operacional</p>
        </div>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-plus me-2"></i>Información del Gasto
                    </h5>
                </div>
                <div class="card-body">
                    <?php if ($error): ?>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="descripcion" 
                                      rows="3" 
                                      placeholder="Describe detalladamente el gasto..."><?php echo htmlspecialchars($_POST['descripcion'] ?? ''); ?></textarea>
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="categoria" name="categoria" required>
                                        ...
                                        <?php foreach ($categorias as $categoria): ?>
                                            <option value="<?php echo $categoria; ?>" <?php echo ($_POST['categoria'] ?? '') == $categoria ? 'selected' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="metodo_pago" name="metodo_pago" required>
                                        ...
                                        <?php foreach ($metodos_pago as $metodo): ?>
                                            <option value="<?php echo $metodo; ?>" <?php echo ($_POST['metodo_pago'] ?? '') == $metodo ? 'selected' : ''; ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="observaciones" 
                                      rows="3" 
                                      placeholder="Observaciones adicionales..."><?php echo htmlspecialchars($_POST['observaciones'] ?? ''); ?></textarea>
                        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h6>Categorías de Gastos:</h6>
                    <ul class="list-unstyled small">
                        <li><span class="badge bg-secondary me-2">Oficina</span> Suministros, papelería</li>
                        <li><span class="badge bg-secondary me-2">Marketing</span> Publicidad, promociones</li>
                        <li><span class="badge bg-secondary me-2">Equipos</span> Hardware, software</li>
                        <li><span class="badge bg-secondary me-2">Servicios</span> Consultorías, mantenimiento</li>
                        <li><span class="badge bg-secondary me-2">Viajes</span> Transporte, hospedaje</li>
                        <li><span class="badge bg-secondary me-2">Otros</span> Gastos diversos</li>
                    </ul>
                    
                    <hr>
                    
                    <h6>Estados del Gasto:</h6>
                    <ul class="list-unstyled small">
                        <li><span class="badge bg-warning me-2">Pendiente</span> Esperando aprobación</li>
                        <li><span class="badge bg-success me-2">Aprobado</span> Gasto autorizado</li>
                        <li><span class="badge bg-danger me-2">Rechazado</span> Gasto no autorizado</li>
                    </ul>
                </div>
            </div>
        </div>
